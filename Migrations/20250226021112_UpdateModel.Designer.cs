...
namespace ASS1.Migrations
{
    ...
    [Migration("20250226021112_UpdateModel")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ASS1.Models.Category", b =>
                {
            ...
            modelBuilder.Entity("ASS1.Models.NewsArticle", b =>
                {
            ...
            modelBuilder.Entity("ASS1.Models.SystemAccount", b =>
                {
            ...
            modelBuilder.Entity("ASS1.Models.Tag", b =>
                {
            ...
            modelBuilder.Entity("ASS1.Models.Category", b =>
                {
                    b.HasOne("ASS1.Models.Category", "ParentCategory")
            ...
            modelBuilder.Entity("ASS1.Models.NewsArticle", b =>
                {
                    b.HasOne("ASS1.Models.Category", "Category")
                        .WithMany("NewsArticles")
                        .HasForeignKey("CategoryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .HasConstraintName("FK_NewsArticle_Category");

                    b.HasOne("ASS1.Models.SystemAccount", "CreatedBy")
                        .WithMany("NewsArticles")
            ...
            modelBuilder.Entity("NewsTag", b =>
                {
                    b.HasOne("ASS1.Models.NewsArticle", null)
                        .WithMany()
                        .HasForeignKey("NewsArticleId")
                        .IsRequired()
                        .HasConstraintName("FK_NewsTag_NewsArticle");

                    b.HasOne("ASS1.Models.Tag", null)
                        .WithMany()
                        .HasForeignKey("TagId")
                        .IsRequired()
